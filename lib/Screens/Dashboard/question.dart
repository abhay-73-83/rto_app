  ...
  final List<Map<String, String>> trafficSigns = [
    {
      'sign': 'Stop Sign',
      'description':
          'A red octagonal sign indicating that vehicles must stop and give way to other traffic.',
      'image': 'assets/stop_sign.jpg',
    },
    {
      'sign': 'Yield Sign',
      'description':
          'A triangular sign indicating that vehicles should slow down or stop to give way to other vehicles.',
      'image': 'assets/yield_sign.jpg',
    },
    {
      'sign': 'Speed Limit 30',
      'description':
          'A round sign indicating the maximum speed of 30 km/h on a particular road.',
      'image': 'assets/speed_limit_30.jpg',
    },
    {
      'sign': 'Speed Limit 50',
      'description':
          'A round sign indicating the maximum speed of 50 km/h on a particular road.',
